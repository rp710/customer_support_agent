...
def create_ticket(customer_id:int,subject:str,description:str,priority:str="medium",status:str="open") -> dict[str,Any]:
    return _tickets.create(customer_id=customer_id,subject=subject,description=description,priority=priority,status=status)
...
def create_draft(ticket_id:int,content:str,context_used:str | None = None,status:str="pending") -> dict[str,Any]:
...
def update_draft(draft_id:int,content:str | None = None,status:str | None = None) -> dict[str,Any]:
    return _drafts.update(draft_id=draft_id,content=content,status=status)

def get_ticket_and_customer_by_draft(draft_id:int)-> dict[str,Any]:
